...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
        ...
        mRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (requestBol){
                    ...
                    //Sending Request Notifications to the driver
                    HashMap<String, String> notificationsdata = new HashMap<>();
                    notificationsdata.put("from", userId);
                    notificationsdata.put("type", "request");

                    mNotifications.child(userId).push().setValue(notificationsdata).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                    ...
                    mRequest.setText("Getting your Delivery....");
    ...
    private void getDriverLocation(){
        driverLocationRef = FirebaseDatabase.getInstance().getReference().child("driversWorking").child(driverFoundID).child("distance");
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        //get the current location from second to second
